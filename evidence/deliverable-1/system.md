...
**REQUIRES MANUAL EXECUTION.** Host previsto: SOC-WIN11. Canal: `System`. Proveedor esperado: Pendiente: proveedor real del evento seleccionado. Evento normal de sistema/servicio. No se ha seleccionado un Event ID.
