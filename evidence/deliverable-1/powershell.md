# Evidencia pendiente: PowerShell
...
**REQUIRES MANUAL EXECUTION.** Host previsto: SOC-WIN11. Canal: `Microsoft-Windows-PowerShell/Operational`. Proveedor esperado: Microsoft-Windows-PowerShell. Nueva sesión Windows PowerShell 5.1 y comando benigno. 4104 es referencia, no un evento observado.
