...
**REQUIRES MANUAL EXECUTION.** Host previsto: SOC-WIN11. Canal: `Security`. Proveedor esperado: Windows Security Auditing. Evento benigno de auditoría (por ejemplo, inicio de sesión exitoso). El ID real se registra al observarlo.
