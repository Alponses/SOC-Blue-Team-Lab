...
Neutralizar esquemas/dominios de URL sospechosas como texto y retirar parámetros sensibles; nunca enlaces Markdown navegables. Los binarios maliciosos quedan excluidos siempre. Un PCAP completo requiere revisión explícita y permanece privado por defecto; se prefieren extractos de texto. No hay descargas ni ejecución de payloads como parte del análisis.
